...
public class AdministrativeArea extends BaseEntity<AdministrativeAreaId> {
  ...
  public static final class Builder {
    ...
    public Builder id(AdministrativeAreaId id) {
      this.id = id;
      return this;
    }

    public Builder name(AreaName name) {
      this.name = name;
      return this;
    }

    public Builder level(AdministrativeLevel level) {
      this.level = level;
      return this;
    }

    public Builder metadata(LandmarkMetadata metadata) {
      this.metadata = metadata;
      return this;
    }

    public Builder geometry(Serializable geometry) {
      this.geometry = geometry;
      return this;
    }

    public Builder parent(AdministrativeAreaId parent) {
      this.parent = parent;
      return this;
    }
