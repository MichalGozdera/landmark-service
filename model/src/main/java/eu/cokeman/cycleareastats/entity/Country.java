...
public class Country extends BaseEntity<CountryId> {
    ...
    public static final class Builder {
        ...
        public Builder id(CountryId id) { this.id = id; return this; }
        public Builder name(String name) { this.name = Objects.requireNonNull(name, "Country name cannot be null"); return this; }
        public Builder createTime(java.time.Instant createTime) { this.createTime = createTime; return this; }
        public Builder updateTime(java.time.Instant updateTime) { this.updateTime = updateTime; return this; }
