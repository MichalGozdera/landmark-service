...
class AdministrativeAreaTest {
    ...
    void builderShouldSetAllFieldsCorrectly() {
        ...
        Country country = Country.builder().id(null).name("TestCountry").createTime(Instant.now()).updateTime(Instant.now()).build();
    ...
    void builderShouldThrowExceptionWhenAreaNameIsNull() {
        assertThrows(IllegalArgumentException.class, () -> new eu.cokeman.cycleareastats.valueObject.AreaName(null));
    }

    @Test
    void builderShouldThrowExceptionWhenLevelNameIsNull() {
        assertThrows(IllegalArgumentException.class, () -> new eu.cokeman.cycleareastats.valueObject.LevelName(null));
    }

    @Test
    void builderShouldThrowExceptionWhenLevelOrderIsNull() {
        assertThrows(IllegalArgumentException.class, () -> new eu.cokeman.cycleareastats.valueObject.LevelOrder(null));
    }
