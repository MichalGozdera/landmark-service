...
public class AdministrativeAreaDomainService {
  ...
  public AdministrativeAreaDomainService(
      AdministrativeAreaRepository areaRepository,
      AdministrativeLevelRepository levelRepository,
  ...
  AdministrativeLevel findExistingLevel(AdministrativeArea administrativeArea) {
    ...
    var matchingLevel =
        levelRepository
            .findByCountryAndName(level.getCountry(), level.getName())
            .orElseThrow(
                () ->
                    new LevelNotFoundException(
                        String.format(
                            "Level with name %s and country %s not found",
                            level.getCountry().getName(), level.getName().name())));
  ...
  private AdministrativeArea persist(
      AdministrativeArea area, EntityEventType eventType, AdministrativeAreaId idIfPresent) {
  ...
  public AdministrativeArea updateAdministrativeArea(
      AdministrativeAreaId areaId, AdministrativeArea area) {
