...
public interface AdministrativeAreaSimpleApi {
  ...
  /**
   * GET /administrative-areas/by-level-country/simple : Get administrative areas by level and
   * country name (simple, without geometry)
   *
  ...
  default ResponseEntity<List<AdministrativeAreaResponseDto>>
      getAdministrativeAreasByLevelAndCountrySimple(
          @NotNull
              @Parameter(
                  name = "levelName",
                  description = "",
  ...
  /**
   * GET /administrative-areas/by-metadata/simple : Get administrative areas by metadata query
   * (simple, without geometry)
   *
  ...
  @RequestMapping(
      ...
      produces = {"application/json"})
  default ResponseEntity<List<AdministrativeAreaResponseDto>>
      getAdministrativeAreasByMetadataSimple(
          @NotNull
              @Parameter(
                  name = "metadataQuery",
                  description = "",
