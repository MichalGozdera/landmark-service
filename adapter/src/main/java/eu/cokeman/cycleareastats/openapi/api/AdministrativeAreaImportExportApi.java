...
@Validated
@Controller
@Tag(name = "administrativeAreaImportExport", description = "the administrativeAreaImportExport API")
public interface AdministrativeAreaImportExportApi {
    ...
    /**
     * GET /administrative-areas/export-kml : Export administrative areas geometries to KML by country and level
     *
    ...
    @Operation(
        ...
        responses = {
            @ApiResponse(responseCode = "200", description = "KML file with geometries", content = {
                @Content(mediaType = "application/vnd.google-earth.kml+xml", schema = @Schema(implementation = org.springframework.core.io.Resource.class))
            })
        }
    )
    @RequestMapping(
    ...
    default ResponseEntity<org.springframework.core.io.Resource> exportAdministrativeAreasKml(
        ...
        @Parameter(name = "fileName", description = "Optional file name for the downloaded KML file", in = ParameterIn.QUERY) @Valid @RequestParam(value = "fileName", required = false) String fileName
    ) {
