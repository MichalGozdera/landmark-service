...
public interface AdministrativeLevelApi {
  ...
  default ResponseEntity<Void> createAdministrativeLevel(
      @Parameter(name = "AdministrativeLevelDto", description = "", required = true)
          @Valid
          @RequestBody
          AdministrativeLevelDto administrativeLevelDto) {
   ...
   * @return Bad Request (status code 400) or OK (status code 204)
   */
  @Operation(
  ...
  default ResponseEntity<Void> deleteAdministrativeLevel(
      @Parameter(
              ...
              required = true,
              in = ParameterIn.PATH)
          @PathVariable("AdministrativeLevelId")
          Integer administrativeLevelId) {
    return new ResponseEntity<>(HttpStatus.NOT_IMPLEMENTED);
  }
        ...
        @ApiResponse(
            ...
            content = {
              @Content(
                  ...
                  schema = @Schema(implementation = AdministrativeLevelDto.class))
            })
      })
  @RequestMapping(
              ...
              for (MediaType mediaType : MediaType.parseMediaTypes(request.getHeader("Accept"))) {
                if (mediaType.isCompatibleWith(MediaType.valueOf("application/json"))) {
                  String exampleString =
                      "{ \"country\" : \"\", \"createTime\" : \"2000-01-23T04:56:07.000+00:00\", \"name\" : \"\", \"updateTime\" : \"2000-01-23T04:56:07.000+00:00\", \"id\" : \"\", \"order\" : \"\" }";
