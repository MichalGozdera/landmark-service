...
@RestController
public class AdministrativeLevelApi
    implements eu.cokeman.cycleareastats.openapi.api.AdministrativeLevelApi {
  ...
  @Override
  public ResponseEntity<Void> createAdministrativeLevel(
      AdministrativeLevelDto levelCreateRequestDto) {
  ...
  public ResponseEntity<AdministrativeLevelDto> loadAdministrativeLevel(Integer levelId) {
    AdministrativeLevel level =
        fetchAdministrativeLevelUseCase.findLevel(new AdministrativeLevelId(levelId));
  ...
  @Override
  public ResponseEntity<AdministrativeLevelDto> updateAdministrativeLevel(
      Integer administrativeLevelId, AdministrativeLevelDto administrativeLevelDto) {
    AdministrativeLevelId areaInternalId = new AdministrativeLevelId(administrativeLevelId);
    AdministrativeLevel level = mapper.mapToInternal(administrativeLevelDto).build();
    AdministrativeLevel updatedLevel =
        updateAdministrativeLevelUseCase.updateAdministrativeLevel(areaInternalId, level);
