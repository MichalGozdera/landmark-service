...
@RestController
public class AdministrativeAreaSimpleApi
    implements eu.cokeman.cycleareastats.openapi.api.AdministrativeAreaSimpleApi {
  ...
  public AdministrativeAreaSimpleApi(
  ...
  public ResponseEntity<List<AdministrativeAreaResponseDto>>
      getAdministrativeAreasByLevelAndCountrySimple(String levelName, String countryName) {
  ...
  @Override
  public ResponseEntity<List<AdministrativeAreaResponseDto>> getAdministrativeAreasByMetadataSimple(
