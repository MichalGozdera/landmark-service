...
public class AreaApplicationService {
  ...
  public AreaApplicationService(
      ...
      CreateAdministrativeAreaUseCase createAdministrativeAreaUseCase) {
  ...
  @Transactional
  public AdministrativeAreaId createAdministrativeArea(
      CreateAdministrativeAreaRequestDto createAdministrativeAreaRequestDto) {
    AdministrativeArea area =
        areaMapper.mapToInternal(createAdministrativeAreaRequestDto.getRequest()).build();
  ...
  @Transactional
  public AdministrativeAreaResponseDto updateAdministrativeArea(
    ...
    AdministrativeArea updatedArea =
        updateAdministrativeAreaUseCase.updateAdministrativeArea(areaInternalId, area);
    return areaMapper.mapToExternal(updatedArea);
  }

  public List<AdministrativeAreaResponseDto> getAdministrativeAreasByLevelAndCountry(
  ...
  public List<AdministrativeAreaResponseDto> getAdministrativeAreasByMetadata(
