...
public class CountryRepository
    implements eu.cokeman.cycleareastats.port.out.persistence.CountryRepository {
  ...
  public Optional<Country> findByName(String name) {
    ...
    return entity != null
        ? Optional.of(CountryJpaMapper.INSTANCE.mapJpaToInternal(entity).build())
        : Optional.empty();
  }
  ...
  public List<Country> findAll() {
    return jpaRepository.findAll().stream()
        .map(r -> CountryJpaMapper.INSTANCE.mapJpaToInternal(r).build())
        .toList();
  }
